...
/**
 * Byte-identical to `ui/landing/src/components/ui/button.tsx` apart from the
 * import order. Edit the two together.
 *
 * It briefly had `up` and `down` variants — filled green and red submits. They
 * are gone. The side of a trade is already stated by the tinted segmented
 * control at the top of the ticket, so a coloured button restates it, and it
 * spends the two colours that mean "the price moved" on a control that is not
 * about the price. The landing's near-black primary is the one action colour,
 * here as there.
 */
